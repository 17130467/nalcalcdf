...
controllingFrame.dispose(); 
	...
	/*Если же будет ошибка, то вызовется диалоговое окно (ошибки) с названием
...
resetFocus(); 
/*Если не нажали на кнопку "ОК", а на "Help", то вызовется диалоговое окно в котором будет
 * пароль "admin"*/
} else { 
JOptionPane.showMessageDialog(controllingFrame, 
"Пароль 'admin'"); 
